...
import com.example.levlog.util.LevDisplayUtil;


public class LevViewPrinterProvider {
    ...
    public LevViewPrinterProvider(FrameLayout rootView, RecyclerView recyclerView) {
    ...
    public void showFloatingView() {
        ...
        params.bottomMargin = LevDisplayUtil.dp2px(100, rootView.getResources());
    ...
    public void showLogView() {
        ...
        FrameLayout.LayoutParams params =
                new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, LevDisplayUtil.dp2px(160, rootView.getResources()));
