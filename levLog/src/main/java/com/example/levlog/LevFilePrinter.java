 ...
 */
public class LevFilePrinter implements LevLogPrinter {
    private static final ExecutorService EXECUTOR = Executors.newSingleThreadExecutor();
    private final String logPath;
    private final long retentionTime;
    private LogWriter writer;
    private volatile PrintWorker worker;
    private static LevFilePrinter instance;
     ...
     */
    public static synchronized LevFilePrinter getInstance(String logPath, long retentionTime) {
        if (instance == null) {
            instance = new LevFilePrinter(logPath, retentionTime);
        }
        return instance;
    }


    private LevFilePrinter(String logPath, long retentionTime) {
    ...
    public void print(@NonNull LevLogConfig config, int level, String tag, @NonNull String printString) {
        ...
        worker.put(new LevLogMo(timeMillis, level, tag, printString));
    }

    private void doPrint(LevLogMo logMo) {
    ...
    private class PrintWorker implements Runnable {
        ...
        private BlockingQueue<LevLogMo> logs = new LinkedBlockingQueue<>();
